                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" style="border: 2px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
                    ...
                    <tr>
                      <td style="padding: 16px; background-color: #f8fafc; border-bottom: 1px solid #e2e8f0;">
                        ...
                        <span style="color: #1e293b; font-size: 14px; font-weight: 600; text-transform: capitalize;">${tripType === 'oneWay' ? 'One-Way Drop' : 'Round Trip'}</span>
                      </td>
                    </tr>
                    <tr>
                      <td style="padding: 16px; background-color: #ffffff;">
                        ...
                        <span style="color: #1e293b; font-size: 14px; font-weight: 600;">${new Date(bookingDate).toLocaleString('en-IN', { 
                          dateStyle: 'full', 
                          timeStyle: 'short' 
                        })}</span>
                      </td>
...
export const sendBookingNotification = async (bookingDetails, adminSettings) => {
  try {
    ...
    const mailOptions = {
      ...
      text: `
        ...
        - Trip Type: ${bookingDetails.tripType === 'oneWay' ? 'One-Way Drop' : 'Round Trip'}
